...
<div class="row" id="movie-list">
    <div class="col-md-3">
        <div class="card">
            <!-- <img src="no_image.webp" class="card-img-top" alt="{{$product->name}}" style="max-height:360px; min-height:360px"> -->
            ...
            <div class="card-body">
                ...
                <a href="#" class="card-link see-detail" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="">See Detail</a>
            </div>
        </div>
    </div>
</div>
