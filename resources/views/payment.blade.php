    ...
    <div class="main-content">
        <div class="trans" id="trans">
            ...
            <form>
                ...
                <div class="mb-3">
                    <label for="phone" class="form-label text-light">Nomor Telepon</label>
                    <input type="tel" class="form-control" value="{{ $user->phone_number }}" id="phone" required />
                </div>
                <div class="mb-3">
                    <label for="payment-method" class="form-label text-light">Metode Pembayaran</label>
                ...
                <div id="credit-card-form" class="credit-card-form">
                    <div class="mb-3">
                        <label for="card-number" class="form-label text-light">Nomor Kartu</label>
                        <input type="text" class="form-control" id="card-number" required />
                    </div>
                    <div class="mb-3">
                        <label for="expiry-date" class="form-label text-light">Tanggal Kadaluarsa</label>
