...
<html lang="en">
    ...
    <body>
        ...
        <div class="jumbotron jumbotron-fluid text-white ">
            <div class="container">
                <h1 class="display-8">Film, acara TV tak terbatas, dan banyak
                    ...
                    Daftar dan mulai berbelanja film favorit mu !</h1>
            </div>
        ...
        <div class="container-film shadow-lg p-3 mb-5 bg-body rounded">
            <h1 class="text-center">Movie On Sale !</h1>

            <div class="container">
                <div class="row row-cols-4 justify-content-center"> <!-- Tambahkan kelas justify-content-center di sini -->
                    <div class="card col mb-4 " style="width: 18rem; height: 40rem;">
                        <img src="Dune.jpeg" class="card-img-top"
                            alt="Dune Movie" style="max-height: 24rem;">
                        <div class="card-body">
                    ...
                    <div class="card col mb-4" style="width: 18rem; height: 40rem;">
                        <img src="Dunkirk.jpeg" class="card-img-top"
                            alt="Dune Movie" style="max-height: 24rem;">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to
                    ...
                    <div class="card col" style="width: 18rem; height: 40rem;">
                        <img src="PeakyBlinders.jpeg" class="card-img-top"
                            alt="Dune Movie" style="max-height: 24rem;">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to
                    ...
                    <div class="card col" style="width: 18rem; height: 40rem;">
                        <img src="endgame.jpeg" class="card-img-top"
                            alt="Dune Movie" style="max-height: 24rem;">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to
